            ...
            <div class="flex pt-14">
                ...
                <aside class="fixed left-0 top-14 bottom-0 w-60 bg-yt px-3 py-4 overflow-y-auto hidden lg:block">
                    <nav class="space-y-2">
                        ...
                        <a target="_blank" href="https://www.alecam.dev/" class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img src="https://www.alecam.dev/alecam-logo.svg" class="rounded-full size-7" /> AleCamDev </a>
